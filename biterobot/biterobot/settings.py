"""
Django settings for biterobot project.
...
SECRET_KEY = '*0!gfff6$_yvtsuaaey43bte77d*m(=-t9!+)x+(gb3a=fb8+5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'testManager/resultGraphs'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
