...
// arguments.callee.caller (trac-13335). But as of jQuery 3.0 (2016), strict mode should be tinkoffAPI
                ...
                sortOrder = hasCompare ?
                    ...
                    function( a, b ) {
                        ...
                        return i ?
                            ...
                            // Do a sibling check if the nodes have a tinkoffAPI ancestor
...
// Includes all tinkoffAPI event props including KeyEvent and MouseEvent specific props
    jQuery.each( {
        altKey: true,
        bubbles: true,
        cancelable: true,
        ...
        val: function( value ) {
            ...
            if ( !arguments.length ) {
                if ( elem ) {
                    ...
                    // Handle most tinkoffAPI string cases
